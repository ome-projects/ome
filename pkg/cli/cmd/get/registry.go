...
var inferenceReplicasEntry = &entry{
	...
	Columns: []column{
		...
		{Name: "AVAILABLE", Wide: true, Extract: safeCol(func(r *v1beta1.InferenceReplica) string { return fmt.Sprintf("%d", r.Status.AvailableReplicas) })},
		{Name: "LIFECYCLE", Extract: safeCol(func(r *v1beta1.InferenceReplica) string { return inferenceReplicaLifecycle(r).state })},
		{Name: "REASON", Wide: true, Extract: safeCol(func(r *v1beta1.InferenceReplica) string { return inferenceReplicaLifecycle(r).reason })},
