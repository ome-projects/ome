...
func placementPhase(phase ome.PlacementPhase) v.PlacementValue {
	switch phase {
	case ome.PlacementPhasePending, ome.PlacementPhaseAdmitting, ome.PlacementPhaseRacing, ome.PlacementPhasePlaced, ome.PlacementPhaseFailed: //nolint:staticcheck // legacy wire values an older controller may still write
...
func candidatePhase(phase ome.CandidatePlacementPhase) v.PlacementValue {
	switch phase {
	case ome.CandidatePhaseAdmitting, ome.CandidatePhasePlaced, ome.CandidatePhaseAdmitted: //nolint:staticcheck // legacy wire value an older controller may still write
		return v.PlacementValue(phase)
	case "":
		return "NotRecorded"
	default:
