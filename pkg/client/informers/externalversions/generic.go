...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1beta1.SchemeGroupVersion.WithResource("autoscalerpolicies"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Ome().V1beta1().AutoscalerPolicies().Informer()}, nil
	...
	case v1beta1.SchemeGroupVersion.WithResource("inferencereplicas"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Ome().V1beta1().InferenceReplicas().Informer()}, nil
	...
	case v1beta1.SchemeGroupVersion.WithResource("trafficmaps"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Ome().V1beta1().TrafficMaps().Informer()}, nil
	case v1beta1.SchemeGroupVersion.WithResource("workloadclusters"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Ome().V1beta1().WorkloadClusters().Informer()}, nil
