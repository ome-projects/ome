...
// Node-local cleanup may later download the same CR instance onto this node again.
...
// This is used for node-local cleanup because the same CR instance may become eligible for the node again.
