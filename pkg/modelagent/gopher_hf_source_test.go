...
func newTestDirectHfSource(t *testing.T) (*Gopher, *GopherTask, hfArtifactTaskInput, directHfSource, *int) {
	...
	// Source tests configure this task between calls. Expose their configured
	// Model through the live API; ownership-race tests use separate live objects.
	s.modelClient.(*omefake.Clientset).PrependReactor("get", "basemodels", func(ktesting.Action) (bool, runtime.Object, error) {
