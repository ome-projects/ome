...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMap":                       schema_pkg_apis_ome_v1beta1_TrafficMap(ref),
		"sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMapCapacity":               schema_pkg_apis_ome_v1beta1_TrafficMapCapacity(ref),
		"sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMapEntry":                  schema_pkg_apis_ome_v1beta1_TrafficMapEntry(ref),
...
func schema_pkg_apis_ome_v1beta1_ModelRehydrationStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ModelRehydrationStatus separates current placement progress from prior completion.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"requestID": {
						SchemaProps: spec.SchemaProps{
							Description: "RequestID is the current request observed from the model annotation.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"completedRequestID": {
						SchemaProps: spec.SchemaProps{
							Description: "CompletedRequestID retains the last completed request, even when new participants join and have not yet acknowledged that request.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"nodesEvicted": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "NodesEvicted records intentional local absence, distinct from download failure.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_ome_v1beta1_TrafficMap(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMapSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMapStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMapSpec", "sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMapStatus"},
	}
}

func schema_pkg_apis_ome_v1beta1_TrafficMapCapacity(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TrafficMapCapacity records why an entry's weight is what it is.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"allocated": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_ome_v1beta1_TrafficMapEntry(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TrafficMapEntry is one serving home's routing target and the provenance of its weight.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"cluster": {
						SchemaProps: spec.SchemaProps{
							Description: "Cluster is the WorkloadCluster serving this home.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"endpoint": {
						SchemaProps: spec.SchemaProps{
							Description: "Endpoint is the home's externally-addressable URL, taken from status.placement.candidates[].endpoint.",
							Ref:         ref("knative.dev/pkg/apis.URL"),
						},
					},
					"weight": {
		...
		Dependencies: []string{
			"knative.dev/pkg/apis.URL", "sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMapCapacity", "sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMapProbe"},
	}
}

func schema_pkg_apis_ome_v1beta1_TrafficMapGatewayRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TrafficMapGatewayRef points at the data plane object a publisher created to realize a TrafficMap.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"group": {
						SchemaProps: spec.SchemaProps{
							Description: "Group is the API group of the realizing object (e.g. \"gateway.networking.k8s.io\"). Empty means the core group.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"kind": {
						SchemaProps: spec.SchemaProps{
							Description: "Kind is the object kind (e.g. \"HTTPRoute\").",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"namespace": {
						SchemaProps: spec.SchemaProps{
							Description: "Namespace is the object namespace. Empty means the TrafficMap's namespace.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_ome_v1beta1_TrafficMapList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMap"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMap"},
	}
}

func schema_pkg_apis_ome_v1beta1_TrafficMapProbe(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"consecutiveFailures": {
						SchemaProps: spec.SchemaProps{
							Description: "ConsecutiveFailures counts unbroken Failing verdicts. The weight is gated only once this reaches the configured failure threshold: a single dropped packet must not move a large traffic share, and the reprogramming churn from flapping would itself be the outage.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"message": {
						SchemaProps: spec.SchemaProps{
							Description: "Message explains the current Result — the observed status code, the transport error, or why the probe could not run.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_ome_v1beta1_TrafficMapSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"mode": {
						SchemaProps: spec.SchemaProps{
							Description: "Mode mirrors the ISVC's spec.placement.mode (Single/All/Split) so a consumer can read the routing intent without reading the ISVC.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"entries": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Entries is the routing table: one entry per serving home, each with its endpoint, final apply-verbatim weight, and the capacity/health provenance of that weight. Consumers apply the weights directly — no gating, fallback, or normalization is left for them to redo.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMapEntry"),
									},
								},
							},
						},
					...
					"observedISVCGeneration": {
						SchemaProps: spec.SchemaProps{
							Description: "ObservedISVCGeneration is the InferenceService generation this table was computed from, so a consumer can detect staleness relative to the source.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
		...
		Dependencies: []string{
			"sigs.k8s.io/ome/pkg/apis/ome/v1beta1.TrafficMapEntry"},
	}
}

func schema_pkg_apis_ome_v1beta1_TrafficMapStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
